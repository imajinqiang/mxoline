    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('institutions', '培训机构'), ('personal', '个人'), ('universities', '高校')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age', models.IntegerField(default=0, max_length=3, verbose_name='年龄')),
                ('work_years', models.IntegerField(default=0, verbose_name='工作年限')),
                ('work_company', models.CharField(max_length=50, verbose_name='就职公司')),
                ('work_position', models.CharField(max_length=10, verbose_name='职位')),
